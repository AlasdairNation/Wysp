...
class GetInfo(plugin_interface):
    def __init__(self):
        ...
        self._runFile = "pacman.py"
        self._gameName = 'Python Pacman' # Name of main game file.
        self.writeFiles = ['search.py', 'searchAgents.py','commands.txt'] # Files which can be edited.
        self.readFiles = ['All'] # Files which can be read, Make a list of files that you want them to read or use 'All' for full access.
        self._programType = "python"
